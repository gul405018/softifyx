...
window.PRModule = {
    ...
    addEmptyRow: function() {
        ...
        tr.innerHTML = `
            <td style="border: 1px solid #cbd5e0; text-align: center; font-size: 10px; background: #f8fafc; border-left: 1px solid #cbd5e0; border-right: 1px solid #cbd5e0;">${rowCount + 1}</td>
            <td style="border: 1px solid #cbd5e0; border-left: 1px solid #cbd5e0; border-right: 1px solid #cbd5e0;"><input type="text" class="grid-input item-code-search"></td>
            <td style="border: 1px solid #cbd5e0; border-left: 1px solid #cbd5e0; border-right: 1px solid #cbd5e0;"><input type="text" class="grid-input item-name" readonly tabindex="-1"></td>
            <td style="border: 1px solid #cbd5e0; border-left: 1px solid #cbd5e0; border-right: 1px solid #cbd5e0;"><input type="text" class="grid-input num pieces" value=""></td>
            <td style="border: 1px solid #cbd5e0; border-left: 1px solid #cbd5e0; border-right: 1px solid #cbd5e0;"><input type="text" class="grid-input num qty" value=""></td>
            <td style="border: 1px solid #cbd5e0; border-left: 1px solid #cbd5e0; border-right: 1px solid #cbd5e0;"><input type="text" class="grid-input unit" readonly tabindex="-1"></td>
            <td style="border: 1px solid #cbd5e0; border-left: 1px solid #cbd5e0; border-right: 1px solid #cbd5e0;"><input type="text" class="grid-input num rate" value=""></td>
            <td style="border: 1px solid #cbd5e0; border-left: 1px solid #cbd5e0; border-right: 1px solid #cbd5e0;"><input type="text" class="grid-input num val-excl" readonly tabindex="-1" value=""></td>
            <td style="border: 1px solid #cbd5e0; border-left: 1px solid #cbd5e0; border-right: 1px solid #cbd5e0;"><input type="text" class="grid-input num tax-rate" value=""></td>
            <td style="border: 1px solid #cbd5e0; border-left: 1px solid #cbd5e0; border-right: 1px solid #cbd5e0;"><input type="text" class="grid-input num tax-amt" readonly tabindex="-1" value=""></td>
            <td style="border: 1px solid #cbd5e0; border-left: 1px solid #cbd5e0; border-right: 1px solid #cbd5e0;"><input type="text" class="grid-input num ftax-rate" value=""></td>
            <td style="border: 1px solid #cbd5e0; border-left: 1px solid #cbd5e0; border-right: 1px solid #cbd5e0;"><input type="text" class="grid-input num ftax-amt" readonly tabindex="-1" value=""></td>
            <td style="border: 1px solid #cbd5e0; border-left: 1px solid #cbd5e0; border-right: 1px solid #cbd5e0;"><input type="text" class="grid-input num val-incl" readonly tabindex="-1" value=""></td>
            <input type="hidden" class="item-coa-id">
        `;

        // Numeric fields logic
        const numInputs = tr.querySelectorAll('.num:not([readonly])');
        numInputs.forEach(input => {
            input.addEventListener('focus', function() {
                if (this.value === '0.00' || this.value === '0') this.value = '';
            });
            input.addEventListener('blur', function() {
                if (this.value === '' || isNaN(parseFloat(this.value))) this.value = '';
    ...
    calculateTotals: function() {
        ...
        document.querySelectorAll('#prGridBody tr').forEach(tr => {
            ...
            totFTax += parseFloat(tr.querySelector('.ftax-rate').value) || 0;
    ...
    setupAutocomplete: function() {
        ...
        const vSuggest = document.getElementById('vendor_suggest');

        if (window.setupSmartSearch) {
            setupSmartSearch(vCode, 'vendor_code', (v) => {
                vCode.value = v.code;
