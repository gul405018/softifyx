...
-- 10. Regions Table (Maintain: Customer Regions)
...
-- 11. Business Sectors Table (Maintain: Business Sectors)
...
-- 12. Employees Table (Maintain: Employees)
...
-- 13. Customers Extended Table (Maintain: Customers)
-- Link to coa_list for basic code/name sync
CREATE TABLE IF NOT EXISTS `customers_ext` (
  ...
  `remarks` text,
  PRIMARY KEY (`coa_list_id`),
  FOREIGN KEY (`coa_list_id`) REFERENCES `coa_list`(`id`) ON DELETE CASCADE,
  FOREIGN KEY (`company_id`) REFERENCES `companies`(`id`) ON DELETE CASCADE,
  FOREIGN KEY (`region_id`) REFERENCES `regions`(`id`) ON DELETE SET NULL,
  FOREIGN KEY (`sub_region_id`) REFERENCES `regions`(`id`) ON DELETE SET NULL,
